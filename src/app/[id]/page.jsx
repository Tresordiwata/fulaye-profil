...
import { Activity, Download, Facebook, HomeIcon, LucideActivity, Mail, PhoneCall, User2, User2Icon, UserCircle, Youtube } from "lucide-react";
...
export default function Home({ params }) {
    ...
    return (
        <div className="min-h-screen bg-gray-200">
            ...
            <div className="mt-3 min-h-20 bg-white px-10 flex flex-col gap-4 pt-7 pb-4">
                ...
                <div className="flex gap-4 justify-between items-center">
                    {
                        profil?.facebook!==null&&
                            <a href={profil?.facebook}><img src={logoFacebook} width={30} height={30} className="rounded" /></a>
                    }
                    {
                        profil?.youtube!==null&&
                            <a href={profil?.youtube}> <img src={logoYoutube} width={70} height={30} className="rounded" /></a>
                    }
                    {
                        profil?.tiktok!==null&&
                            <a href={profil?.tiktok}><img src={logoTikTok} width={70} height={30} className="rounded" /></a>
                    }
                    {
                        (profil?.facebook==null && profil?.youtube==null && profil?.tiktok==null) &&
                            <span className="text-red-300  font-bold">Aucun réseau social enregistré pour ce profil</span> 
                    }
