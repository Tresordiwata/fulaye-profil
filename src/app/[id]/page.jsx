...
export default function Home({ params }) {
    ...
    useEffect(() => {
        ...
        getData("profil&idProfil=" + params?.id).then((r) => {
            if (r?.data?.length == 0) {
                setFeedBack(
                    <div className="flex justify-center items-center">
                        <div className="max-w-[75%] w-[75%] mt-10 py-4 rounded-md flex justify-center items-center tetx-2xl text-red-800 bg-red-300 border border-red-600">
